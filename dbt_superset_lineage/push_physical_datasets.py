...
def merge_columns_info(dataset, dbt_tables, debug_dir):
    ...
    main_timestamp_column = meta_dbt.get('bi_integration', {}).get('main_timestamp_column')
    meta_new['main_dttm_col'] = main_timestamp_column.upper() if main_timestamp_column else None
